---
name: zeos-exp002-fingerprint-a
...
displayName: EXP002 Fingerprint A
profession: Test probe
maxTurns: 3
skills: []
---

# EXP-002 Fingerprint Probe A

> ⚠️ **A 层脱敏副本。** 原始定义正文内嵌一个运行时随机生成的 signature，
> 按 `EXP-002-workbuddy-control-plane.md` H5 的要求"不写进公开 experiment 文档"，
> 此处以 `<REDACTED-SIG-A>` 代替。**真值仅存于 B 层**（`~/Desktop/项目思考/EXP-002-evidence/notes/`）。
